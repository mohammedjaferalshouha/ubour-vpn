...
class UpdateServiceTest {
    ...
    fun testCurrentAppVersionNotEmpty() {
        ...
        assertEquals("1.1.0", UpdateService.CURRENT_APP_VERSION)
    }
    ...
    fun testUpdateInfoDataClass() {
        val updateInfo = UpdateInfo(
            ...
            releasePageUrl = "https://github.com/mohammedjaferalshouha/ubour-vpn/releases/tag/v1.2.0"
        )
        assertTrue(updateInfo.hasUpdate)
        assertEquals("1.2.0", updateInfo.latestVersion)
